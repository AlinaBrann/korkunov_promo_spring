      ...
      if (this.submitStatus !== "PENDING") {
        ...
        this.$store
          ...
          .catch((e) => {
            ...
            if (error.indexOf('timeout of')) {
              this.$modal.show("succes_popup", {
                text: "Вы&nbsp;получите уведомление о&nbsp;статусе на&nbsp;указанный электронный адрес. <br>Обработка видеопоздравления может занимать до&nbsp;3&nbsp;часов.<br /><br /><a href='/' class='btn btn--primary'>на главную</a>"
            });
            }
