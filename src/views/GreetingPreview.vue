<template>
  <constructor-step title="просмотр видеопоздравления">
    <div class="constructor-step__video-wrapper">
      ...
      ></video>
      <button
        @click="pass ? showVideoPopup() : showErorr()"
        class="constructor-step__video-overlay"
      ></button>
    </div>

    <div class="constructor-step__social" v-if="pass">
    ...
    <router-link to="/" class="constructor-step__button btn btn--primary">
...
export default {
  ...
  mounted() {
    this.code = this.$route.query.pincode;
    this.$store
